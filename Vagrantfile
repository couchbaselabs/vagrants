...
couchbase_download_links = {
  ...
  "4.0.0-testing" => {
              ...
              "debian8-unsupported"  => "http://latestbuilds.hq.couchbase.com/couchbase-server/sherlock/2093/couchbase-server-enterprise_4.0.0-2093-debian7_amd64",
              "opensuse11"   => "http://latestbuilds.hq.couchbase.com/couchbase-server/sherlock/2093/couchbase-server-enterprise-4.0.0-2093-opensuse11.3.x86_64",
              "opensuse12-unsupported"  => "http://packages.couchbase.com/releases/4.0.0-dp/couchbase-server-enterprise-4.0.0-dp-suse11.3.x86_64",
