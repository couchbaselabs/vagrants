...
couchbase_download_links = {
  ...
  "4.0.0-rc" => {
              ...
              "opensuse11"   => "http://packages.couchbase.com/releases/4.0.0-rc0/couchbase-server-enterprise-4.0.0-rc0-suse11.3.x86_64",
              "opensuse12-unsupported" => "http://packages.couchbase.com/releases/4.0.0-rc0/couchbase-server-enterprise-4.0.0-rc0-suse11.3.x86_64",
