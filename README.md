...
> **Note**
> If you are using VirtualBox 6.1.28 on macOS or Linux, you may encounter a `E_ACCESSDENIED` error when starting the nodes. As a workaround, you can create the file `/etc/vbox/networks.conf` containing `* 0.0.0.0/0 ::/0`.
